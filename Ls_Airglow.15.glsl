// Airglow pass 15: accelerated Gaussian blur, size / 64.000000, direction vec2(0.0, 1.0)
// lewis@lewissaunders.com

#extension GL_ARB_shader_texture_lod : enable

uniform sampler2D strength, adsk_results_pass14;
...
void main() {
  ...
  gl_FragColor = gaussianblur(adsk_results_pass14, downlod, downxy, downres, downs, downs, downs, downs, vec2(0.0, 1.0));
}
