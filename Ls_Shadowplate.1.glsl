...
// Pass 1: convert to working space
...
void main(void) {
	...
	// Convert to our working space
	vec3 xyz = rgb2xyz(inp);
	vec3 working = vec3(0.0);
	if(space == 0) {
		working = xyz2rgb(xyz);
	} else if(space == 1) {
		working = xyz;
		...
		working = xyz2lab05cc(xyz);
	} else if(space == 5) {
		working = xyz2lchab(xyz);
	} else if(space == 6) {
		working = xyz2luv(xyz);
	} else if(space == 7) {
		working = xyz2luv05cc(xyz);
	} else if(space == 8) {
		working = xyz2lchuv(xyz);
	} else if(space == 9) {
		working = xyz2oklab(xyz);
	} else if(space == 10) {
		working = xyz2oklab05cc(xyz);
	} else if(space == 11) {
		working = xyz2hsv(xyz);
	} else if(space == 12) {
		working = xyz2hsl(xyz);
	} else if(space == 13) {
		working = xyz2ycbcr(xyz);
	} else if(space == 14) {
		working = xyz2ypbpr(xyz);
	}

	gl_FragColor = vec4(working, 0.0);
}
