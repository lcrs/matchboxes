// Airglow pass 11: accelerated Gaussian blur, size / 16.000000, direction vec2(0.0, 1.0)
// lewis@lewissaunders.com

#extension GL_ARB_shader_texture_lod : enable

uniform sampler2D strength, adsk_results_pass10;
...
void main() {
  ...
  float s = max(size * strength / 16.000000, 0.0001);
  ...
  gl_FragColor = gaussianblur(adsk_results_pass10, downlod, downxy, downres, downs, downs, downs, downs, vec2(0.0, 1.0));
}
